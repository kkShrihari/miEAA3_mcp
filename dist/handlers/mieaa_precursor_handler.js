...
export class MiEAAPrecursorHandler {
    ...
    async runAnalysis(options) {
        ...
        const selected = this.parseCategorySelection(options.category_selection ?? "all", options.categories);
        options.categories = selected;
        // Build body
        const body = this.buildBody(options);
        // Start job
        const startJob = await startMiEAAJob(body, options.species, "precursor", options.analysis_type);
...
//# sourceMappingURL=mieaa_precursor_handler.js.map