...
// =============================================================
export async function listMiEAACategories(
  species: string,
  entity: "mirna" | "precursor"
): Promise<any | MiEAAError> {

  const url =
    `https://ccb-compute2.cs.uni-saarland.de/mieaa/api/v1/enrichment_categories/${species}/${entity}/`;
  ...
  try {
    ...
    return {
      species,
      entity,
      categories: json.categories.map((c: any, idx: number) => ({
        index: idx + 1,
        id: c[0],
        name: c[1]
      }))
...
// 7. FETCH JOB STATUS
// =============================================================
export async function fetchMiEAAJobStatus(
  jobId: string
): Promise<any | MiEAAError> {

  const url =
    `https://ccb-compute2.cs.uni-saarland.de/mieaa/api/v1/job_status/${jobId}/`;
...
// =============================================================
export async function fetchMiEAAJobResultsDirect(
  jobId: string
): Promise<any | MiEAAError> {
